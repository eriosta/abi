          ...
          {isEmpty ? (
            ...
            <div className="flex flex-col gap-2 p-3 sm:gap-3 sm:p-4">
              ...
              <button
                type="button"
                onClick={onOrderSms}
                className="inline-flex w-full items-center justify-center gap-1.5 text-xs font-bold text-abi-ink/70 underline decoration-abi-mist underline-offset-4 transition hover:text-abi-ink hover:decoration-abi-deep sm:text-sm"
              >
